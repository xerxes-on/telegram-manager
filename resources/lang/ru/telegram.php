...
return [
    ...
    'support_text_detailed' => "🆘 Центр поддержки\n\n📞 Call Центр: :phone\n💬 Telegram: :telegram\n\n⏰ Время работы: 09:00 - 18:00 (Пн-Пт)",
    ...
    'my_card_button' => '💳 Моя карта',
    'free_plan_card_explanation' => "Для бесплатного плана оплата не взимается, но добавление карты необходимо для подтверждения того, что вы реальный клиент 😇",
    'subscription_renewal_max_retries_reached' => "Уважаемый :name, мы пытались обновить вашу подписку :retry_count раз(а), но безуспешно. Ваша подписка была отменена. Пожалуйста, подпишитесь снова.",
    'plan_not_found' => "План подписки не найден. Пожалуйста, выберите снова.",
    'card_error_try_again' => "Ошибка при добавлении карты. Пожалуйста, попробуйте еще раз.",
    'card_add_failed' => "Не удалось добавить карту. Пожалуйста, введите другой номер карты.",
    'welcome_back' => "🏠 Главная страница",
    
    // Renewal messages
    'subscription_renewed_success' => "✅ Ваша подписка успешно продлена!\n📅 Тариф: :plan\n📆 Действует до: :expires_at",
    'subscription_renewal_failed' => "⚠️ Ошибка при продлении подписки.\n📅 До окончания осталось :days_left дней.",
    'subscription_expired_kicked' => "❌ Ваша подписка истекла и вы были удалены из канала.\n\n📱 Для оформления новой подписки нажмите кнопку ниже:",
    'renewal_not_available' => '⚠️ Подписку еще нельзя продлить. Вы сможете продлить её за 3 дня до окончания.',
    'no_cards_for_renewal' => '❌ Карта для продления подписки не найдена. Пожалуйста, добавьте карту.',
    'renewal_payment_failed' => '❌ Оплата не прошла. Попробуйте добавить другую карту или повторите попытку.',
    'subscription_expiring_reminder' => "⏰ До окончания вашей подписки осталось :days дней!\n\n📅 Тариф: :plan\n📆 Дата окончания: :expires_at\n\n💳 Для продления подписки нажмите кнопку ниже:",
    
    // Button texts  
    'pay_now_button' => '💳 Оплатить сейчас',
    'view_plans_button' => '📱 Посмотреть тарифы',
    'add_new_card_button' => '💳 Добавить новую карту',
